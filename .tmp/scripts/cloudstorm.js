(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["cloudstorm"] = factory();
	else
		root["cloudstorm"] = factory();
})(this, function() {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var CloudStorm = function () {
	  function CloudStorm() {
	    var _this = this;

	    _classCallCheck(this, CloudStorm);

	    var formView = (0, _template.getFormView)();
	    var loadingView = (0, _template.getLoadingView)();

	    this.containerView = (0, _jquery2.default)('#cloudstorm');
	    this.containerView.html(formView);
	    (0, _event.bindFormEvents)(this.containerView);

	    (0, _jquery2.default)(this.containerView).find('#cs-btn').on('click', function (event) {
	      var self = _this;
	      var formData = (0, _service.getFormData)(_this.containerView);
	      _this.containerView.html(loadingView);
	      (0, _service.getWeather)(formData).then(function (data) {
	        data.form = formData;
	  ...
	  _createClass(CloudStorm, [{
	    key: 'displayWeatherWidget',
	    value: function displayWeatherWidget(data) {
	      var displayView = (0, _template.getDisplayView)(data);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.bindFormEvents = undefined;
	...
	var bindFormEvents = function bindFormEvents(containerView) {
	  (0, _jquery2.default)(containerView).find('#cs-checkbox').on('change', function (event) {
	    (0, _jquery2.default)(containerView).find('#cs-wind-value').text(event.target.checked);
	  });

	  (0, _jquery2.default)(containerView).find('input[type=radio][name=cs-radio]').on('change', function (event) {
	    (0, _jquery2.default)(containerView).find('#cs-unit-value').text(this.value);
	  });
	};

	exports.bindFormEvents = bindFormEvents;
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getDisplayView = getDisplayView;
	exports.getFormView = getFormView;
	exports.getLoadingView = getLoadingView;
	...
	**/
	function getDisplayView(data) {
	  var temp = (0, _helper.getRoundedNumber)(data.list[0].main.temp, 1);
	  var getToday = (0, _helper.getDateTime)(data.list[0].dt_txt);
	  var windDetails = data.form.wind ? 'Wind | Speed - ' + data.list[0].wind.speed + ' | Degree -' + data.list[0].wind.deg : '';
	  var icon = (0, _icon.getIcon)(data.list[0].weather[0].icon);
...
/***/ function(module, exports) {
	...
	var getRoundedNumber = function getRoundedNumber(number, precision) {
	...
	exports.getRoundedNumber = getRoundedNumber;
...
/***/ function(module, exports) {
	...
	function getIcon(id) {
	  var icons = {
	    ...
	    "sleet": "<div class='icon flurries'><div class='cloud'></div><div class='snow'><div class='flake'></div><div class='flake'></div></div></div>",
	    "wind": "<div class='icon cloudy'><div class='cloud'></div><div class='cloud'></div></div>",
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.getFormData = exports.getCurrentLatLong = exports.getWeather = undefined;
	...
	var getWeather = function getWeather(request) {
	  var baseUrl = 'http://api.openweathermap.org/data/2.5/forecast';
	  var apiKey = '94cef7632d2dad3775d9e44e4d5453bb';

	  return new Promise(function (resolve, reject) {
	    getCurrentLatLong().then(function (coords) {
	      var query = '?lat=' + coords.latitude + '&lon=' + coords.longitude + '&appid=' + apiKey + '&units=' + request.unit;
	...
	var getCurrentLatLong = function getCurrentLatLong() {
	  var locationUrl = 'http://ip-api.com/json'; //fallback if user denies permission
	  return new Promise(function (resolve, reject) {
	    if (navigator.geolocation) {
	      navigator.geolocation.getCurrentPosition(function (position) {
	        resolve(position.coords);
	      }, function () {
	        _jquery2.default.getJSON(locationUrl, function (data) {
	          resolve({
	            latitude: data.lat,
	            longitude: data.lon
	          });
	...
	var getFormData = function getFormData(containerView) {
	  var title = (0, _jquery2.default)(containerView).find('#title').val();
	  var unit = (0, _jquery2.default)(containerView).find('input[type=radio][name=cs-radio]:checked').val();
	  var wind = (0, _jquery2.default)(containerView).find('#cs-checkbox').is(':checked');
	  return {
	    title: title,
	    unit: unit,
	    wind: wind
	...
	exports.getCurrentLatLong = getCurrentLatLong;
